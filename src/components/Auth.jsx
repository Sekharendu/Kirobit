    ...
    >
      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl text-xl font-bold text-white"
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            style={{ background: '#232323', border: '1px solid #2a2a2a', color: '#c9c9c9' }}
        ...
        <p className="mt-6 text-center text-xs" style={{ color: '#444444' }}>
