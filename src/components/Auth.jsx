...
<div className="flex min-h-screen items-center justify-center bg-[#0f0f0f]">
  <div className="w-full max-w-sm rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] p-8 shadow-2xl">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            <h1 className="text-xl font-semibold text-slate-100">Welcome to Notes</h1>
            <p className="mt-1 text-sm text-slate-400">Sign in to your personal workspace</p>
          </div>
        </div>
